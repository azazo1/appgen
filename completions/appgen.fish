...
# Options
complete -c appgen -s e -l executable -d "Path to the executable file to package" -r -f
...
complete -c appgen -s a -l additional-file -d "Additional files to include" -r -f
